...
namespace Application.Common.Utility
{
    ...
    public class EmailValidator : RegularExpressionValidator
    {
        ...
        public EmailValidator(string message)
            : base(!string.IsNullOrEmpty(message) ? message : "Invalid Email", Expression)
        { }
    ...
    public class Enumvalidator : BaseValidator
    {
        ...
        public Enumvalidator(string message)
            : base(!string.IsNullOrEmpty(message) ? message : "Is not Defined in Enum")
        { }
    ...
    public class MaxLengthValidator : BaseValidator
    {
        ...
        public MaxLengthValidator(string message, long maxLength)
            : base(!string.IsNullOrEmpty(message) ? message : "Exceeded maximum length")
        {
            MaxLength = maxLength;
        }
    ...
    public class RegularExpressionValidator : BaseValidator
    {
        ...
        public RegularExpressionValidator(string message, string expression)
            : base(!string.IsNullOrEmpty(message) ? message : "No Match with pattern")
        {
    ...
    public class RequiredFieldValidator : BaseValidator
    {
        ...
        public RequiredFieldValidator(string message)
            : base(!string.IsNullOrEmpty(message) ? message : "Is required")
        {
        }
    ...
    /// <summary>
    ///     Permite realizar validaciones sobre las propiedades que tengan Atributos de tipo ValidationAttribute para cualquier
    ///     entidad o clase
    /// </summary>
